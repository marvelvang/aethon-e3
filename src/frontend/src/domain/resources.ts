...
export type ResourceKey = 'population' | 'consumerGoods' | 'industry' | 'housing'
export type ResourceGainKey = 'populationGain' | 'consumerGoodsGain' | 'industryGain' | 'housingGain'
