...
public static class BuildingDefinitions
{
    ...
    {
        [BuildingType.Base]       = new(0,  0,  100, 200, 150, 0,  0),
        [BuildingType.Consumer]   = new(25, 15, 40,  0,   0,   15, 0),
        [BuildingType.Industry]   = new(40, 70, 10,  50,  0,   70, 0),
        [BuildingType.Housing]    = new(50, 60, 0,   0,   20,  60, 0),
        [BuildingType.PowerPlant] = new(40, 70, 0,   0,   0,   70, 50),
    };
