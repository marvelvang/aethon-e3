...
public static class BuildingDefinitions
{
    private static readonly Dictionary<BuildingType, BuildingDefinition> _all = new()
    {
        ...
        [BuildingType.Consumer]   = new(25, 15, 40,  0,   0,   0, 0),
        [BuildingType.Industry]   = new(40, 70, 10,  50,  0,   0, 0),
        [BuildingType.Housing]    = new(50, 60, 0,   0,   20,  0, 0),
        [BuildingType.PowerPlant] = new(40, 70, 0,   0,   0,   0, 50),
    };
